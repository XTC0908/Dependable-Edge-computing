...
(defsystem "edge_info-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "vhc_cmd" :depends-on ("_package_vhc_cmd"))
    (:file "_package_vhc_cmd" :depends-on ("_package"))
    (:file "vhc_geo" :depends-on ("_package_vhc_geo"))
    (:file "_package_vhc_geo" :depends-on ("_package"))
    (:file "vhc_path" :depends-on ("_package_vhc_path"))
    (:file "_package_vhc_path" :depends-on ("_package"))
  ))